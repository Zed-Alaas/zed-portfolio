...
(() => {
  ...
  const COMMANDS = {
    help: () => [
      ...
      '  <span class="t-accent">services</span>   — the kinds of projects I build',
    ...
    skills: () => [
      '<span class="t-dim">what I build →</span>',
      '  business &amp; brand sites · community platforms',
      '  personal brands · restaurants &amp; online stores',
      '<span class="t-dim">under the hood →</span> modern, fast, hand-coded web tech',
    ],
    services: () => COMMANDS.skills(),
    projects: () => [
      '<span class="t-accent">001</span> Ruba\'s Circle — personal brand + booking · rubascircle.ca',
      '<span class="t-accent">002</span> Silaa — bilingual community platform · silaa.me',
      '<span class="t-accent">003</span> MENA Minds — B2B consulting site · mena-minds.com',
      '<span class="t-accent">004</span> Speducci — restaurant &amp; online store · speducci.com',
      '<span class="t-dim">scroll to \'work\' to explore, or \'contact\' to team up</span>',
    ],
    contact: () => [
